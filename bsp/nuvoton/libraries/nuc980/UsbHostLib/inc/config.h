...
#define IS_OHCI_IRQ_ENABLED()  ((inpw(REG_AIC_INTMSK0)>>IRQ_OHCI) & 0x1)
...
#define OHCI_PORT_CNT          8            /* Number of OHCI roothub ports               */
...
typedef struct
{
    ...
    __IO uint32_t HcRhPortStatus[8];     /*!< [0x0054] Host Controller Root Hub Port Status [1]                         */
    __I  uint32_t RESERVE0[99];
...
#define USBH                 ((USBH_T *)0xB0017000)
#define HSUSBH               ((HSUSBH_T *)0xB0015000)

/*----------------------------------------------------------------------------------------*/
/*   Select USBH Lite  multi-function pin                                                 */
/*----------------------------------------------------------------------------------------*/
#define USBHL0_MFP_DP_B4       outpw(REG_SYS_GPB_MFPL, ((inpw(REG_SYS_GPB_MFPL) & 0xFFF0FFFF) | 0x00040000))
#define USBHL0_MFP_DM_B6       outpw(REG_SYS_GPB_MFPL, ((inpw(REG_SYS_GPB_MFPL) & 0xF0FFFFFF) | 0x04000000))
#define USBHL0_MFP_DP_B5       outpw(REG_SYS_GPB_MFPL, ((inpw(REG_SYS_GPB_MFPL) & 0xFF0FFFFF) | 0x00400000))
#define USBHL0_MFP_DM_B7       outpw(REG_SYS_GPB_MFPL, ((inpw(REG_SYS_GPB_MFPL) & 0x0FFFFFFF) | 0x40000000))
#define USBHL0_MFP_DP_B10      outpw(REG_SYS_GPB_MFPH, ((inpw(REG_SYS_GPB_MFPH) & 0xFFFFF0FF) | 0x00000400))
#define USBHL0_MFP_DM_B9       outpw(REG_SYS_GPB_MFPH, ((inpw(REG_SYS_GPB_MFPH) & 0xFFFFFF0F) | 0x00000040))
#define USBHL0_MFP_DP_D15      outpw(REG_SYS_GPD_MFPH, ((inpw(REG_SYS_GPD_MFPH) & 0x0FFFFFFF) | 0x50000000))
#define USBHL0_MFP_DM_D14      outpw(REG_SYS_GPD_MFPH, ((inpw(REG_SYS_GPD_MFPH) & 0xF0FFFFFF) | 0x05000000))

#define USBHL1_MFP_DP_F1       outpw(REG_SYS_GPF_MFPL, ((inpw(REG_SYS_GPF_MFPL) & 0xFFFFFF0F) | 0x00000060))
#define USBHL1_MFP_DM_F0       outpw(REG_SYS_GPF_MFPL, ((inpw(REG_SYS_GPF_MFPL) & 0xFFFFFFF0) | 0x00000006))
#define USBHL1_MFP_DP_E1       outpw(REG_SYS_GPE_MFPL, ((inpw(REG_SYS_GPE_MFPL) & 0xFFFFFF0F) | 0x00000060))
#define USBHL1_MFP_DM_E0       outpw(REG_SYS_GPE_MFPL, ((inpw(REG_SYS_GPE_MFPL) & 0xFFFFFFF0) | 0x00000006))

#define USBHL2_MFP_DP_F3       outpw(REG_SYS_GPF_MFPL, ((inpw(REG_SYS_GPF_MFPL) & 0xFFFF0FFF) | 0x00006000))
#define USBHL2_MFP_DM_F2       outpw(REG_SYS_GPF_MFPL, ((inpw(REG_SYS_GPF_MFPL) & 0xFFFFF0FF) | 0x00000600))
#define USBHL2_MFP_DP_E3       outpw(REG_SYS_GPE_MFPL, ((inpw(REG_SYS_GPE_MFPL) & 0xFFFF0FFF) | 0x00006000))
#define USBHL2_MFP_DM_E2       outpw(REG_SYS_GPE_MFPL, ((inpw(REG_SYS_GPE_MFPL) & 0xFFFFF0FF) | 0x00000600))

#define USBHL3_MFP_DP_F5       outpw(REG_SYS_GPF_MFPL, ((inpw(REG_SYS_GPF_MFPL) & 0xFF0FFFFF) | 0x00600000))
#define USBHL3_MFP_DM_F4       outpw(REG_SYS_GPF_MFPL, ((inpw(REG_SYS_GPF_MFPL) & 0xFFF0FFFF) | 0x00060000))
#define USBHL3_MFP_DP_E5       outpw(REG_SYS_GPE_MFPL, ((inpw(REG_SYS_GPE_MFPL) & 0xFF0FFFFF) | 0x00600000))
#define USBHL3_MFP_DM_E4       outpw(REG_SYS_GPE_MFPL, ((inpw(REG_SYS_GPE_MFPL) & 0xFFF0FFFF) | 0x00060000))

#define USBHL4_MFP_DP_E7       outpw(REG_SYS_GPE_MFPL, ((inpw(REG_SYS_GPE_MFPL) & 0x0FFFFFFF) | 0x60000000))
#define USBHL4_MFP_DM_E6       outpw(REG_SYS_GPE_MFPL, ((inpw(REG_SYS_GPE_MFPL) & 0xF0FFFFFF) | 0x06000000))
#define USBHL4_MFP_DP_G10      outpw(REG_SYS_GPG_MFPH, ((inpw(REG_SYS_GPG_MFPH) & 0xFFFFF0FF) | 0x00000400))
#define USBHL4_MFP_DM_A15      outpw(REG_SYS_GPA_MFPH, ((inpw(REG_SYS_GPA_MFPH) & 0x0FFFFFFF) | 0x40000000))
#define USBHL4_MFP_DP_B13      outpw(REG_SYS_GPB_MFPH, ((inpw(REG_SYS_GPB_MFPH) & 0xFF0FFFFF) | 0x00600000))
#define USBHL4_MFP_DM_F6       outpw(REG_SYS_GPF_MFPL, ((inpw(REG_SYS_GPF_MFPL) & 0xF0FFFFFF) | 0x06000000))
#define USBHL4_MFP_DP_F7       outpw(REG_SYS_GPF_MFPL, ((inpw(REG_SYS_GPF_MFPL) & 0x0FFFFFFF) | 0x60000000))

#define USBHL5_MFP_DP_F9       outpw(REG_SYS_GPF_MFPH, ((inpw(REG_SYS_GPF_MFPH) & 0xFFFFFF0F) | 0x00000060))
#define USBHL5_MFP_DM_F8       outpw(REG_SYS_GPF_MFPH, ((inpw(REG_SYS_GPF_MFPH) & 0xFFFFFFF0) | 0x00000006))
#define USBHL5_MFP_DP_E9       outpw(REG_SYS_GPE_MFPH, ((inpw(REG_SYS_GPE_MFPH) & 0xFFFFFF0F) | 0x00000060))
#define USBHL5_MFP_DM_E8       outpw(REG_SYS_GPE_MFPH, ((inpw(REG_SYS_GPE_MFPH) & 0xFFFFFFF0) | 0x00000006))
#define USBHL5_MFP_DP_A14      outpw(REG_SYS_GPA_MFPH, ((inpw(REG_SYS_GPA_MFPH) & 0xF0FFFFFF) | 0x04000000))
#define USBHL5_MFP_DM_A13      outpw(REG_SYS_GPA_MFPH, ((inpw(REG_SYS_GPA_MFPH) & 0xFF0FFFFF) | 0x00400000))
#define USBHL5_MFP_DP_B12      outpw(REG_SYS_GPB_MFPH, ((inpw(REG_SYS_GPB_MFPH) & 0xFFF0FFFF) | 0x00040000))
#define USBHL5_MFP_DM_B11      outpw(REG_SYS_GPB_MFPH, ((inpw(REG_SYS_GPB_MFPH) & 0xFFFF0FFF) | 0x00004000))
