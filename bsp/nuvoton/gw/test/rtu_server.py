...
def run_async_server():
    ...
    store = ModbusSlaveContext(
        ...
        hr=ModbusSequentialDataBlock(1, [12,34,56,78]+[12]*196),
    ...
    # StartTcpServer(context, identity=identity, address=("192.168.1.235", 5020),
    ...
    StartSerialServer(context, identity=identity,
                      port='/dev/tty.wchusbserial142320', framer=ModbusRtuFramer,timeout=.005, baudrate=9600)
