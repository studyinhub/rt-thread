 ...
 * 2017-11-15     JasonJia     Modify rt_slist_foreach to
 * rt_slist_for_each_entry. Make code cleanup.
 */
...
/**
 * rt_list_for_each_safe - iterate over a list safe against removal of list
 * entry
 * @pos:    the rt_list_t * to use as a loop cursor.
...
/**
 * rt_list_for_each_entry_safe - iterate over list of given type safe against
...
rt_inline rt_slist_t *rt_slist_first(rt_slist_t *l) { return l->next; }
...
rt_inline rt_slist_t *rt_slist_next(rt_slist_t *n) { return n->next; }
